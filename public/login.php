...
<head>
        ...
        <nav class="bg-gray-900 border-gray-200 px-4 lg:px-6 py-2.5">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    <a href="#" class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Masuk</a>
    ...
    ;?></a> </center>
        <div class="flex items-center h-screen w-full">
          ...
          <span class="block w-full text-xl uppercase font-bold mb-4">Masuk</span>      
            <form class="mb-4" action="./backend/login.php" method="post">
              <div class="mb-4 md:w-full">
                <label required name="email" class="block text-xs mb-1">Email</label>
              ...
              <div class="mb-6 md:w-full">
                <label typ="password" name="password" required class="block text-xs mb-1">Kata Sandi</label>
                <input class="w-full border rounded p-2 outline-none focus:shadow-outline focus:bg-slate-100" type="password" name="password" id="password" placeholder="Masukan password kamu">
              </div>
              <input type="submit" value="Login" class="bg-blue-500 hover:bg-blue-700 text-white uppercase text-sm font-semibold px-4 py-2 rounded"></input>
            </form>
            <a>Belum mempunyai akun?</a>
            <a class="text-blue-700 text-center text-sm focus:text-blue-500" href="register.html">Daftar</a><br>
            <a>Admin?</a>
